...
//    /// </summary>
//    public class UserStore : UserStore<IdentityUser<int>>, IUserStoreWithCustomClaims<int>
//    {
...
//            var claims = await db.RoleClaims.Where(x => roles.Any(r => r == x.RoleId)).Distinct().ToListAsync();
//            return claims.Select(appClaim => new Claim(appClaim.ClaimType, appClaim.ClaimValue));
//        }
//    }
...
//    public class UserStore<TUser> : UserStore<TUser, UbikRole, DbContext>
...
//    public class UserStore<TUser, TRole, TContext> : UserStore<TUser, TRole, TContext, int>
//        where TUser : IdentityUser<int>, new()
...
//            Context.Entry<TUser>(user).State = EntityState.Modified;
//            try
//            {
//                await SaveChanges(cancellationToken);
//            }
