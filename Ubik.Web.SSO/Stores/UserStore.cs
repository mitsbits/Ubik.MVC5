...
//        IUserLoginStore<UbikUser>,
//        IUserRoleStore<UbikUser>,
//        IUserClaimStore<UbikUser>,
//        IUserPasswordStore<UbikUser>,
//        IUserSecurityStampStore<UbikUser>,
//        IUserEmailStore<UbikUser>,
//        IUserLockoutStore<UbikUser>,
//        IUserPhoneNumberStore<UbikUser>,
//        IQueryableUserStore<UbikUser>,
...
//        public UserStore(IDbContextScopeFactory dbContextScopeFactory, IUserRepository userRepo, IRoleRepository roleRepo, IClaimRepository claimRepo, IdentityErrorDescriber describer = null)
//        {
...
//        public virtual Task<string> GetUserIdAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
...
//        public virtual Task<string> GetUserNameAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual Task SetUserNameAsync(UbikUser user, string userName, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual Task<string> GetNormalizedUserNameAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public virtual Task SetNormalizedUserNameAsync(UbikUser user, string normalizedName, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public async virtual Task<IdentityResult> CreateAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public async virtual Task<IdentityResult> UpdateAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation, containing the <see cref="IdentityResult"/> of the update operation.</returns>
//        public async virtual Task<IdentityResult> DeleteAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// </returns>
//        public async virtual Task<UbikUser> FindByIdAsync(string userId, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
...
//        /// The <see cref="Task"/> that represents the asynchronous operation, containing the user matching the specified <paramref name="userID"/> if it exists.
//        /// </returns>
//        public virtual Task<UbikUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
...
//        /// </summary>
//        public virtual IQueryable<UbikUser> Users
//        {
//            get
//            {
//                return _userRepo.GetQuery();
//            }
//        }
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public virtual Task SetPasswordHashAsync(UbikUser user, string passwordHash, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual Task<string> GetPasswordHashAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public async virtual Task AddToRoleAsync(UbikUser user, string roleName, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public async virtual Task RemoveFromRoleAsync(UbikUser user, string roleName, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual async Task<IList<string>> GetRolesAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public async virtual Task<IList<Claim>> GetClaimsAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            ThrowIfDisposed();
//            if (user == null)
//            {
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public async virtual Task ReplaceClaimAsync(UbikUser user, Claim claim, Claim newClaim, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            ThrowIfDisposed();
//            if (user == null)
//            {
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public async virtual Task RemoveClaimsAsync(UbikUser user, IEnumerable<Claim> claims, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            ThrowIfDisposed();
//            if (user == null)
//            {
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public virtual async Task RemoveLoginAsync(UbikUser user, string loginProvider, string providerKey,
//            CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
...
//        /// </returns>
//        public async virtual Task<IList<UserLoginInfo>> GetLoginsAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// </returns>
//        public async virtual Task<UbikUser> FindByLoginAsync(string loginProvider, string providerKey,
//            CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
...
//        /// </returns>
//        public virtual Task<bool> GetEmailConfirmedAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual Task SetEmailConfirmedAsync(UbikUser user, bool confirmed, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The task object representing the asynchronous operation.</returns>
//        public virtual Task SetEmailAsync(UbikUser user, string email, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual Task<string> GetEmailAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// </returns>
//        public virtual Task<string> GetNormalizedEmailAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The task object representing the asynchronous operation.</returns>
//        public virtual Task SetNormalizedEmailAsync(UbikUser user, string normalizedEmail, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// </returns>
//        public virtual Task<DateTimeOffset?> GetLockoutEndDateAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public virtual Task SetLockoutEndDateAsync(UbikUser user, DateTimeOffset? lockoutEnd, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual Task<int> IncrementAccessFailedCountAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual Task ResetAccessFailedCountAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual Task<int> GetAccessFailedCountAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// </returns>
//        public virtual Task<bool> GetLockoutEnabledAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public virtual Task SetLockoutEnabledAsync(UbikUser user, bool enabled, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public virtual Task SetPhoneNumberAsync(UbikUser user, string phoneNumber, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual Task<string> GetPhoneNumberAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// </returns>
//        public virtual Task<bool> GetPhoneNumberConfirmedAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public virtual Task SetPhoneNumberConfirmedAsync(UbikUser user, bool confirmed, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public virtual Task SetSecurityStampAsync(UbikUser user, string stamp, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        public virtual Task<string> GetSecurityStampAsync(UbikUser user, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
//        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
//        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
//        public virtual Task SetTwoFactorEnabledAsync(UbikUser user, bool enabled, CancellationToken cancellationToken = default(CancellationToken))
//        {
//            cancellationToken.ThrowIfCancellationRequested();
//            ThrowIfDisposed();
//            if (user == null)
...
{
    public class UserStore : UserStoreBase<UbikUser, UbikRole, AuthDbContext, int>, IUserStoreWithCustomClaims<int>
    {
        public UserStore(IAmbientDbContextLocator ambientDbContextLocator,
        ...
        {
            var q = from c in Context.RoleClaims
    ...
    public abstract class UserStoreBase<TUser, TRole, TContext, TKey> :
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public UserStoreBase(IAmbientDbContextLocator ambientDbContextLocator,
        ...
        {
            return AutoSaveChanges ? _db.SaveChangesAsync(cancellationToken) : Task.FromResult(0);
        }
